...
- `DATABASE_URL` — данные для подключения к базе данных PostgrSQL:
```sh
...
Активируйте сервис для отслеживания и сбора ошибок [Rollbar](https://rollbar.com/)
```
- ROLLBAR_ACCESS_TOKEN='youк token Rollbar>
- ROLLBAR_ENVIRONMENT= имя окружения, по умолчанию 'production'
```
